...
// [ApiController]
// [Route("[controller]")]
// public class ContactController : ApiController<AccountController>
// {
//     readonly ILogger<AccountController> _logger;
//     readonly AccountLogic _accountLogic;
//     readonly ContactCreateLogic _organisationLogic;
//     readonly IMapper _mapper;
//     public ContactController(ILogger<AccountController> logger, IMapper mapper)
//     {
//         _logger = logger;
//         _mapper = mapper;
